...
void TriggerExplorer::createCategory() {
	...
	expand(index);
	selectionModel()->setCurrentIndex(model()->index(parent_item->children.size() - 1, 0, index), QItemSelectionModel::SelectionFlag::ClearAndSelect);
}
